...
//$delete=$_POST["delete"];
//$change=$_POST["change"];
$filename1="mission_3-4-8.txt";
$filename2="mission_3-4-8x.txt";
//$editNumber = '';
//$editName = '';
//$editComment = '';
...
if(!empty($_POST["name"])&&!empty($_POST["comment"])){
	...
	fwrite($file,$num."<>".$_POST["name"]."<>".$_POST["comment"]."<>".date("Y/m/d  H:i:s" , $timestamp )."\r\n");
	fclose($file);
...
<br />
パスワード<br />
//<textarea name="password1" rows="4" cols="40"><?php echo $editPassword1; ?></textarea>
...
<br />
パスワード<br />
//<textarea name="password3" rows="4" cols="40"><?php echo $editPassword3; ?></textarea>
